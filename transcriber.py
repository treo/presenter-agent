...
assistant = Agent(
        instructions="",
   vad=silero.VAD.load(
       min_silence_duration=1.5,       # Wait 1.5 seconds of silence before stopping (default: 0.55s)
       prefix_padding_duration=0.8,    # Add 0.8s padding to beginning of speech (default: 0.5s)
   ),
   stt=openai.STT(),
